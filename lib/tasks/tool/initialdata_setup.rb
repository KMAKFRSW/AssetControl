    ...
    for num in 2..360 do
      ...
      if weekday == 1 || weekday == 2 || weekday == 3 || weekday == 4 || weekday == 5 then
        ...
        arr_calc_target.each do |term, item_code|
          ...
          ", yesterday, term, yesterday,'USD/JPY','EUR/JPY','EUR/USD','AUD/JPY','AUD/USD','GBP/JPY','GBP/USD'])
...
class Tasks::Calculate_Term_Range_Setup
  def self.execute
    ##############################################################
    # calc following performance items :                         #
    #     Daily Range                                            #
    ...
    for num in 2..360 do
      ...
      if weekday == 1 || weekday == 2 || weekday == 3 || weekday == 4 || weekday == 5 then
        ...
        ", yesterday, 'USD/JPY', 'EUR/JPY','EUR/USD','AUD/JPY','AUD/USD','GBP/JPY','GBP/USD'])
...
class Tasks::Calculate_Term_Return_Setup
  def self.execute
    ##############################################################
    # calc following performance items :                         #
    #     Daily Return                                           #
...
class Tasks::Calculate_Term_Risk_Setup
  def self.execute
    ##############################################################
    # calc following performance items :                         #
    #     prev_rate, range                                       #
    ...
    ", yesterday, yesterday, 'USD/JPY', 'EUR/JPY','EUR/USD','AUD/JPY','AUD/USD','GBP/JPY','GBP/USD'])
