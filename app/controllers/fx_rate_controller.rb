...
class FxRateController < ApplicationController
  def index
    ...
    @usdjpy_price_graph = LazyHighCharts::HighChart.new('graph') do |f|
      ...
      f.yAxis [
        ...
        {:title => {:text => '値幅'    }, :min =>   0, :max =>   5, tickInterval: 2 , format: '{value} 円' , opposite: true}
      ]
      ...
      f.series(:yAxis => 1, :type => 'line', name: '値幅'        , data: usdjpy_range_array      , pointFormat: '値幅:         <b>{point.y:.3f} 円</b>')
    end
  ...
  ########################################################
    ...
    @eurjpy_price_graph = LazyHighCharts::HighChart.new('graph') do |f|
      ...
      f.series(:yAxis => 1, :type => 'line', name: '値幅'        , data: eurjpy_range_array      , pointFormat: '値幅:         <b>{point.y:.3f} 円</b>')
    end
  ...
  ########################################################
    ...
    @eurusd_price_graph = LazyHighCharts::HighChart.new('graph') do |f|
      ...
      f.yAxis [
        ...
        {:title => {:text => '値幅'    }, :min =>   0, :max => 0.03, tickInterval: 0.01 , format: '{value} ＄' , opposite: true}
      ]
      ...
      f.series(:yAxis => 1, :type => 'line', name: '値幅'        , data: eurusd_range_array      , pointFormat: '値幅:         <b>{point.y:.3f} ＄</b>')
    end
